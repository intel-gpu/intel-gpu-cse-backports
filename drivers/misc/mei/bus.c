 ...
 * Return:  0 on success; < 0 otherwise
 */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5,15,0) || SUSE_RELEASE_VERSION_GEQ(15,4,0)
#define device_remove_return_type_void
#endif

#ifdef device_remove_return_type_void
...
#ifndef device_remove_return_type_void
	return 0;
#endif
}
